# Apply the KIT-hhh4 model using shuffled rather than ordered quantile paths,
# otherwise with default settings.
...
shuffle_paths <- TRUE # this is the relevant change here.
